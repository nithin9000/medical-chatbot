...
from doctor_utils import find_specialist_doctors,extract_specialist_city,SPECIALIST_SYNONYMS,GREETING_KEYWORDS
...
async def chat(req: ChatRequest):
    ...
    if message.lower() in GREETING_KEYWORDS:
        return{
            "response":"👋 Hello! I’m MedMistral, your medical assistant. How can I help you today?"
        }
    else:
